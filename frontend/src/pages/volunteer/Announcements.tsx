    ...
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      ...
      {announcements.length === 0 ? (
        ...
        <div className="space-y-4">
          {announcements.map(a => (
            <div key={a.id} className={`card p-5 transition-all ${a.is_read ? 'opacity-60 grayscale bg-slate-50 border-black' : 'bg-white hover:-translate-y-1 hover:shadow-[4px_4px_0px_#000]'}`}>
              ...
              <div className="flex items-center gap-6 font-mono text-xs text-slate-500 border-t-2 border-black pt-3">
